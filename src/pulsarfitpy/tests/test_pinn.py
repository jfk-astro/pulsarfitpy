...
class TestPulsarPINNInitialization:
    ...
    def test_initialization_with_deepxde_backend(
        self, simple_ode_equation, mock_atnf_query
    ):
    ...
    def test_initialization_with_pytorch_backend(
        self, simple_ode_equation, mock_atnf_query
    ):
    ...
    def test_initialization_with_custom_architecture(
        self, simple_ode_equation, mock_atnf_query
    ):
    ...
    def test_initialization_with_cuda_device(
        self, simple_ode_equation, mock_atnf_query
    ):
    ...
    def test_invalid_backend_should_raise_error(
        self, simple_ode_equation, mock_atnf_query
    ):
...
class TestPulsarPINNMethods:
    ...
    def pinn_instance(self):
        ...
        pinn = PulsarPINN(
            equation=equation, atnf_query=query, domain=(0.0, 10.0), backend="pytorch"
        )
...
class TestPulsarPINNEquationParsing:
    ...
    def test_ode_equation_format(self):
        ...
        assert t in equation.free_symbols or any(
            t in arg.free_symbols for arg in equation.args
        )
...
class TestPulsarPINNTrainingInputs:
    ...
    def test_loss_weights_structure(self):
        ...
        loss_weights = {"pde": 1.0, "bc": 1.0, "data": 1.0}
