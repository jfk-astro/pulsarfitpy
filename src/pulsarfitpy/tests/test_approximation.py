...
class TestPulsarApproximation:
    ...
    def test_log_transformation(self, mock_query):
        ...
        expected_log_periods = np.log10(original_periods[np.isfinite(original_periods) & (original_periods > 0)])
    ...
    def test_verbose_mode_produces_output(self, mock_query, caplog):
        ...
        with caplog.at_level(logging.INFO):
            ...
            assert any('Fitting Polynomial' in record.message for record in caplog.records)
